...
- ✅ **Art. 30 Records of Processing** — updated to v2 to cover suspended/claim-lifetime retention + the anonymized ML store (`article30.md`).
- ✅ **DPIA** — updated to v2 for this processing (`dpia-sensor-data.md`).
