...
| Lawful basis | Art. 6(1)(b) Contract for active service; **Art. 6(1)(f) legitimate interest** for retaining an owned-but-suspended device's history, with an **Art. 21 opt-out** (full LIA: `legitimate-interest-assessment.md`) |
...
| Lawful basis | Out of GDPR scope — rendered **anonymous** (Recital 26) before retention; derived from data originally held under §3.3. Supported by the LIA motivated-intruder test (Appendix A, residual risk low) + conformity check (Appendix B); re-reviewed if regulatory guidance changes |
