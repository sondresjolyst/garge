...
| Lawful basis for retention beyond contract | **Art. 6(1)(f) legitimate interest** — preserving the owner's own history (incl. year-over-year across seasonal gaps), with an **Art. 21 opt-out**. Full LIA: `legitimate-interest-assessment.md` |
